...
<ul class="navbar-nav me-auto mb-2 mb-lg-0">
    ...
    <li class="nav-item"><a class="nav-link text-light" href="#"><?php echo $TopMenuLang['Main'];?></a>
        <ul>
            <li><a href="<?php If ($MenuQueryOK == True){echo $LeagueGeneralMenu['OutputName'] . ".stc";}?>"><?php echo $TopMenuLang['STHSClientLeagueFile'];?></a></li>
            ...
            if($CookieTeamNumber > 0){
                ...
                if ($LeagueWebClientMenu['AllowTradefromWebsite'] == "True" AND $LeagueGeneralMenu['TradeDeadLinePass'] == "False" AND $CookieTeamNumber > 0){echo "<li><a href=\"Trade.php\">". $TopMenuLang['Trade'] . "</a></li>";}
                ...
                if ($LeagueWebClientMenu['AllowDraftSelectionfromWebsite'] == "True" AND $CookieTeamNumber <= 100 AND $LeagueGeneralMenu['OffSeason'] == "True" AND $LeagueGeneralMenu['EntryDraftStart'] == "True" AND $LeagueGeneralMenu['EntryDraftStop'] == "False" AND $LeagueGeneralMenu['FantasyDraftStart'] == "False"){echo "<li><a href=\"DraftSelection.php?EntryDraft\">" . $TopMenuLang['EntryDraftSelection'] . "</a></li>";}
                if ($LeagueWebClientMenu['AllowDraftSelectionfromWebsite'] == "True" AND $CookieTeamNumber <= 100 AND $LeagueGeneralMenu['OffSeason'] == "True" AND $LeagueGeneralMenu['EntryDraftStart'] == "False" AND $LeagueGeneralMenu['EntryDraftStop'] == "False" AND $LeagueGeneralMenu['FantasyDraftStart'] == "True"){echo "<li><a href=\"DraftSelection.php?FantasyDraft\">" . $TopMenuLang['FantasyDraftSelection'] . "</a></li>";}
                echo "<li><a href=\"NewsManagement.php\">" . $TopMenuLang['LeagueNewsManagement'] . "</a></li>";
                echo "<li><a href=\"" . $LoginLink . "\">". $TopMenuLang['Logout'] . "</a></li>";
            }elseif($DoNotRequiredLoginDynamicWebsite == TRUE){
                echo "<li><a href=\"Upload.php\">" . $TopMenuLang['UploadLine'] . "</a></li>";
                if ($LeagueOutputOptionMenu['ShowWebClientInDymanicWebsite'] == "True"){echo "<li><a href=\"WebClientIndex.php\">" . $TopMenuLang['WebClient'] . "</a></li>";}
                echo "<li><a href=\"Login.php\">". $TopMenuLang['Login'] . "</a></li>";
            }else{
                echo "<li><a href=\"Login.php\">". $TopMenuLang['Login'] . "</a></li>";
            }
            ...
            If ($CookieTeamNumber == 102){echo "<li><a href=\"SendEmail.php\">" . $TopMenuLang['Email'] . "</a></li>";}
            }?>
        </ul>
    </li>
    <li class="nav-item"><a class="nav-link text-light" href="#!"><?php echo $TopMenuLang['TeamsDirectLink'];?></a>
        <ul>
        <?php
            If ($MenuQueryOK == True){
            /* Pro */
            echo "<li><a class=\"nav-link text-light\" href=\"#\">". $TopMenuLang['ProTeam'] , "</a><ul>\n";
            ...
            If ($LeagueSimulationMenu['FarmEnable'] == "True"){
                /* Farm */
                echo "<li><a class=\"nav-link text-light\" href=\"#\">". $TopMenuLang['FarmTeam'] , "</a><ul>\n";
...
<li><a href="#" class="MenuAfterImage nav-link text-light"><?php echo $TopMenuLang['ProLeague'];?></a><ul>
...
If ($LeagueSimulationMenu['FarmEnable'] == "True"){
	...
	echo "<li><a href=\"#\" class=\"MenuAfterImage nav-link text-light\">" . $TopMenuLang['FarmLeague'] . "</a><ul>";
...
<li><a href="#" class="MenuAfterImage nav-link text-light"><?php echo $TopMenuLang['League'];?></a><ul>
...
<li><a href="#" class="nav-link text-light"><?php If (file_exists($CareerStatDatabaseFile) == true){echo $TopMenuLang['RecordsAndCareerStat'];}else{echo $TopMenuLang['Records'];}?></a><ul>
<?php
...
<li><a href="Search.php" class="nav-link text-light"><?php echo $TopMenuLang['Search'];?></a></li>
<?php
If ($MenuQueryOK == True){
...
<li><a href='#' class="nav-link text-light"><?php echo $TopMenuLang['Help'];?></a><ul>
...
<div class="STHSPHP_Login">
	...
	If ($CookieTeamNumber > 0 AND $CookieTeamNumber <= 100){
		...
		echo "<div><a class=\"STHSPHPLoginButton\" href=\"Login.php\">". $TopMenuLang['Login'] . "</a><i class=\"fa fa-sign-in\" aria-hidden=\"true\"></i></div>";
	}
	?>
	</div>
</div>
